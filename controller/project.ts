...
export const addNewProject = async(req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const {
            ...
            ProjectName, AmountRequired, ProjectCardImage, ProjectTagLine,
        ...
        const response = await user.addProject(ChainId, ProjectId, ProjectName, AmountRequired, ProjectCardImage, ProjectTagLine, OrganizationName, OrganizationWebsite, YoutubeLink, ContactPersonLastname, ContactPersonOthernames, WalletAddress);
...
export const editProject = async(req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const {
            ...
            AmountRequired, ProjectCardImage, ProjectTagLine,
            OrganizationName, OrganizationWebsite, YoutubeLink,
            ContactPersonLastname, ContactPersonOthernames,
        ...
        const response = await user.updateProject(Id, ChainId, ProjectId, ProjectName, AmountRequired, ProjectCardImage, ProjectTagLine, OrganizationName, OrganizationWebsite, YoutubeLink, ContactPersonLastname, ContactPersonOthernames, WalletAddress, SenderAddress, PollId);
